...
$.FroalaEditor.RegisterCommand('readMore', {
  ...
  callback: function() {
    this.html.insert('<div class="froala-read-more-break"><!-- truncate --></div>');
...
export function initMiniEditor(selector) {
  $(selector).froalaEditor({
    ...
    toolbarButtons: ['bold', 'italic', 'underline', 'strikeThrough', 'color', 'emoticons', 'paragraphFormat', 'align', 'formatOL', 'formatUL', 'indent', 'outdent', 'insertLink', 'undo', 'redo']
  })
}
